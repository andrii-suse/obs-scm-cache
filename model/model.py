...
class Obsproj(Base):
    ...
    __table_args__ = (PrimaryKeyConstraint("name", name="obsproj_pkey"),)
...
class Scmrepo(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["scmhost_id"], ["scmhost.id"], name="scmrepo_scmhost_id_fkey"
        ),
        ...
        UniqueConstraint(
            ...
            "repo",
            "branch",
            name="scmrepo_scmhost_id_org_repo_branch_key",
        ),
    )
    ...
    scmhost: Mapped[Optional["Scmhost"]] = relationship(
        "Scmhost", back_populates="scmrepo"
    )
...
class Scmpkg(Base):
    ...
    __table_args__ = (
        ...
        ForeignKeyConstraint(
            ["scmrepo_id"], ["scmrepo.id"], name="scmpkg_scmrepo_id_fkey"
        ),
    ...
    scmrepo: Mapped[Optional["Scmrepo"]] = relationship(
        "Scmrepo", back_populates="scmpkg"
    )
